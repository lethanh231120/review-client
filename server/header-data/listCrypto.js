...
const LIST_DESCRIPTION = `Discover Gear5's comprehensive list of ${totalCryptoProject} Crypto Projects includes detailed ratings, discuss & essential information and watch out which projects are reported as Scam or Dead! `

const SUB_CATEGORY_TITLE = `All ${REPLACE_SUB_CATEGORY} Projects | Rating, Discuss & Details | Gear5`
const SUB_CATEGORY_DESCRIPTION = `Explore the ${REPLACE_SUB_CATEGORY} and its top Crypto Projects on Gear5 with detailed ratings, discuss, and essential information and watch out which projects are reported as Scam or Dead!
`
const staticData = {
  title: LIST_TITLE,
