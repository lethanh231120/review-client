...
export const PrivacyPolicy = () => {
  ...
  return <div className='term'>
    ...
    <div className='term-content' style={{ height: 'auto' }}>
      ...
      <div>
        <p className='term-content-sub'>
        If you have any questions, comments, or concerns regarding our Privacy Policy and/or practices, please contact us at <i className='text-primary'>zoro@gear5.guru</i> or by writing Nika JSC at 10th floor, Viet A Building, 9 Duy Tan, Dich Vong Hau Ward, Cau Giay District, Hanoi, Vietnam.
        </p>
      </div>
    </div>
  </div>
