    ...
    <div className='list-review'>
      <div className='list-review-header'>
        <div className='text-primary list-review-header-title'>
          {defaultText === 'All Review' ? <h2 className='mb-0 text-primary fs-20' style={{ display: 'inline' }}>{productInfo?.details?.name} Reviews</h2> : <span style={{ color: defaultText === 'Report Scam' ? 'red' : '' }}>{defaultText}</span>}
