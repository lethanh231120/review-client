                ...
                <div className='profile-details'>
                  ...
                  <div className='profile-email px-2 pt-2'>
                    <h4 className='text-muted mb-0'>
                      Round type: {itemDetail?.roundType}
                    </h4>
                    <p>
                      Launched at: <IconImageList listLaunchpad={itemDetail?.launchPads} />
                    </p>
                  </div>
                ...
                <div className='card-body'>
                  <div className='profile-statistics'>
                    <div className='text-center'>
                      <div className='row'>
                        <div className='col'>
                          <h3 className='m-b-0'>{formatLargeNumberMoneyUSD(itemDetail?.fundRaisingGoals)}</h3>
                          <span>Raised</span>
                        </div>
                        <div className='col'>
                          <h3 className='m-b-0'>{formatLargeNumberMoneyUSD(itemDetail?.fullyDilutedMarketcap)}</h3> <span>Marketcap</span>
                        </div>
                        <div className='col'>
                          <h3 className='m-b-0'>{formatLargeNumber(itemDetail?.totalSupply)}</h3> <span>Supply</span>
                        </div>
                      </div>
                      <div className='mt-4'>
                        <Button
